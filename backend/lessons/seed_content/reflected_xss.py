...
FA_LESSON = {
    **LESSON,
    "steps": [
        ...
        [{"type": "strong", "text": "قربانی"}, {"type": "break"}, {"type": "text", "text": "بعد Vic به وب‌سایت مخرب Mal منتقل می‌شود."}],
    ...
    "quiz_intro": {
        ...
        "summary": "با این آزمون کوتاه مطمئن شو مفهوم XSS بازتابی را درست گرفته‌ای.",
    ...
    "quiz": {
        **LESSON["quiz"],
        "title": "آزمون: XSS بازتابی",
        "instructions": "با این آزمون کوتاه مطمئن شو مفهوم XSS بازتابی را درست گرفته‌ای.",
        "questions": [
            {
...
FA_GUIDE = {
    **GUIDE,
    ...
    "quiz_cta": {
        ...
        "label": "آزمون:",
        "title": "XSS بازتابی",
        "summary": "با یک آزمون کوتاه مطمئن شو مفهوم XSS بازتابی را درست گرفته‌ای ←",
