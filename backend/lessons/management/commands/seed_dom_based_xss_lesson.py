...
class Command(BaseCommand):
    help = "Seed the DOM-based XSS lesson into the relational lesson models."
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            raise CommandError(
                "Could not seed DOM-based XSS. Check sort_order uniqueness or existing lesson data."
            ) from exc
...
def create_or_replace_draft_revision(lesson, user):
    ...
    return LessonRevision.objects.create(
        ...
        change_summary="Seed from the DOM-based XSS interactive lesson.",
        created_by=user,
    )
