...
const questions = [
  {
    type: "truefalse",
    text: "Using an Object Relational Mapping tool will make you completely immune to SQL injection attacks.",
    options: ["True", "False"],
    answer: 1,
  },
  {
    type: "truefalse",
    text: "SQL Injection attacks always involve the attacker sending an unexpected quote character.",
    options: ["True", "False"],
    answer: 1,
  },
  {
    type: "multi",
    text: "Which of the following approaches is an effective way of protecting yourself against SQL injection?",
    options: [
