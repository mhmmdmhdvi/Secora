...
function XmlExternalEntities() {
  ...
  return (
    <div className="mx-auto mt-5 w-full max-w-[90rem] overflow-hidden px-3 pb-12 sm:mt-8 sm:px-5 lg:px-8 2xl:px-10">
      ...
      <div className="mx-auto mb-5 flex max-w-3xl flex-wrap justify-center gap-2 sm:mb-8 sm:gap-3">
      ...
      <div className="flex flex-col items-center gap-5 sm:gap-6">
        <button
          ...
          className="relative w-full max-w-2xl rounded-2xl border border-border bg-surface p-4 text-text shadow-md shadow-black/5 transition active:scale-[0.99] sm:p-5 md:p-6"
        ...
        <XxeScene scene={scene} simulation={lesson.simulation} />
      </div>
    </div>
  );
}
